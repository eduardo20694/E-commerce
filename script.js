document.addEventListener("DOMContentLoaded", () => {
    const produtos = [
  { id: 1, nome: "Camiseta Estampada", categoria: "roupas",tamanhos: ["P", "M", "G", "GG"], precoAntigo: 99.90, precoNovo: 79.90, img: "assets/images/camisa2.png", descricao: "Camiseta 100% algodão com estampa moderna e confortável." },
  { id: 2, nome: "Camiseta Estampada", categoria: "roupas",tamanhos: ["P", "M", "G", "GG"], precoAntigo: 79.90, precoNovo: 59.90, img: "assets/images/camisa1.png", descricao: "Camiseta casual com design exclusivo e tecido respirável." },
  ...
  { id: 5, nome: "iPhone 16 Pro", categoria: "celulares", precoAntigo: 8999.99, precoNovo: 7399.99, img: "assets/images/iph16pro.webp", descricao: "iPhone 16 Pro Max Apple 256GB, Câmera Tripla de 48MP, Tela 6,9, Titânio-Deserto" },
  ...
  { id: 13, nome: "Camiseta Estampada", categoria: "roupas",tamanhos: ["P", "M", "G", "GG"], precoAntigo: 79.90, precoNovo: 59.90, img: "assets/images/camisa3.webp", descricao: "Camisa Social Masculina Manga Longa Lisa Slim - LORD FINESSE OUTLET." },
  { id: 14, nome: "Camiseta Estampada", categoria: "roupas",tamanhos: ["P", "M", "G", "GG"], precoAntigo: 79.90, precoNovo: 59.90, img: "assets/images/camisa4.webp", descricao: "Camisa Social Masculina Moda Maior Homens Plus Size - LORD FINESSE CAMISARIA" },
  { id: 15, nome: "Camiseta do Campeão Masculina", categoria: "roupas",tamanhos: ["P", "M", "G", "GG"], precoAntigo: 129.90, precoNovo: 99.90, img: "assets/images/camisa5.webp", descricao: "Camisa Grêmio I 21/22 Umbro Masculina - Azul+Branco" },
  { id: 16, nome: "Camiseta do Campeão Feminina", categoria: "roupas",tamanhos: ["P", "M", "G", "GG"], precoAntigo: 129.90, precoNovo: 99.90, img: "assets/images/camisa6.webp", descricao: "Camisa Grêmio I 25/26 Torcedor Umbro Feminina" },
  { id: 17, nome: "Fone Bluetooth", categoria: "acessorios", precoAntigo: 329.00, precoNovo: 269.00, img: "assets/images/fone2.webp", descricao: "Fone sem fio com cancelamento de ruído e autonomia de até 20 horas." },
  { id: 18, nome: "Fone Bluetooth", categoria: "acessorios", precoAntigo: 299.00, precoNovo: 229.00, img: "assets/images/fone3.webp", descricao: "Fone sem fio com cancelamento de ruído e autonomia de até 20 horas." },
  { id: 19, nome: "Fone Bluetooth", categoria: "acessorios", precoAntigo: 299.00, precoNovo: 239.00, img: "assets/images/fone4.webp", descricao: "Fone sem fio com cancelamento de ruído e autonomia de até 20 horas." },
  { id: 20, nome: "Fone Bluetooth", categoria: "acessorios", precoAntigo: 499.00, precoNovo: 399.00, img: "assets/images/fone5.webp", descricao: "Fone sem fio com cancelamento de ruído e autonomia de até 20 horas." },
  { id: 21, nome: "Kit 3 Camisas", categoria: "roupas",tamanhos: ["P", "M", "G", "GG"], precoAntigo: 229.90, precoNovo: 169.90, img: "assets/images/camisa7.webp", descricao: "Kit 3 Camisas Masculina Manga Longa Social Slim Blusa Luxo (AZUL ROYAL - BRANCO - PRETO)" },
  { id: 22, nome: "Kit 3 Camisas", categoria: "roupas",tamanhos: ["P", "M", "G", "GG"], precoAntigo: 229.90, precoNovo: 169.90, img: "assets/images/camisa8.webp", descricao: "Kit 3 Camisas Masculina Manga Longa Social Slim Blusa Barata (PRETA - MARSALA - AZUL MARINHO) " },
  { id: 23, nome: "Kit 5 Camisas", categoria: "roupas",tamanhos: ["P", "M", "G", "GG"], precoAntigo: 329.90, precoNovo: 269.90, img: "assets/images/camisa9.webp", descricao: "Kit 5 Camisa Polo Envoy Tecido Piquet Básica Masculina" },
  { id: 24, nome: "KIT 4 Camisas Polo Masculina ", categoria: "roupas",tamanhos: ["P", "M", "G", "GG"], precoAntigo: 329.90, precoNovo: 229.90, img: "assets/images/camisa10.webp", descricao: "KIT 4 Camisas Polo Masculina Piquet - Daze Modas" },
...
const popupTamanhos = document.getElementById("popup-tamanhos");
const popupTamanhosContainer = document.getElementById("popup-tamanhos-container");
const erroTamanho = document.getElementById("erro-tamanho");

popupTamanhos.innerHTML = "";
erroTamanho.style.display = "none";

if (produtoSelecionado.tamanhos) {
  popupTamanhosContainer.style.display = "block";

  produtoSelecionado.tamanhos.forEach(tam => {
    const btn = document.createElement("button");
    btn.className = "botao-tamanho";
    btn.textContent = tam;

    btn.addEventListener("click", () => {
      // Remove seleção de todos os botões
      document.querySelectorAll(".botao-tamanho").forEach(b => {
      ...
      produtoSelecionado.tamanhoEscolhido = tam;
      erroTamanho.style.display = "none";
    });

    popupTamanhos.appendChild(btn);
  });
} else {
  popupTamanhosContainer.style.display = "none";
  delete produtoSelecionado.tamanhoEscolhido;
}
